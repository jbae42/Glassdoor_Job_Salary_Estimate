# -*- coding: utf-8 -*-
"""
Created on Wed Jan  6 20:54:56 2021
...
def get_jobs(keyword, num_jobs, verbose, path, slp_time):
    ...
    while len(jobs) < num_jobs:  #If true, should be still looking for new jobs.
        ...
        time.sleep(slp_time)
        #driver.find_element_by_class_name("gdGrid pageContentWrapper").click()
        driver.find_element_by_class_name("pointerCountWrapper").click()
...
# =============================================================================
        ...
        for job_button in job_buttons: 
            ...
            try:
                ...
                driver.find_element_by_xpath('.//div[@class="tab" and @data-tab-type="job"]').click()
